...
import FloatingChatButton from "@/components/FloatingChatButton"; // <-- Importa aquí
...
export default function DashboardTecnico() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-3">
            ...
            {/* Agregar botón de chat en el header también */}
            <button
      ...
      {/* Agrega el botón flotante de chat aquí, AL FINAL DEL DIV PRINCIPAL */}
      <FloatingChatButton />
    </div>
  );
}
