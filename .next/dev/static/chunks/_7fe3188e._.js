...
function CrearMaquina() {
    ...
    const [fotoFile, setFotoFile] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    function handle(e) {
        setForm({
            ...form,
    ...
    async function subirFoto() {
        ...
        const nombre = `maquinas/${Date.now()}-${fotoFile.name}`;
        const { data, error } = await supabase.storage.from("fotos").upload(nombre, fotoFile);
        if (error) return null;
        const { data: url } = supabase.storage.from("fotos").getPublicUrl(nombre);
...
_s(CrearMaquina, "e4mJRHAaK97hNs9aGw6ph/zkT8c=", false, function() {
    return [
...
_c = CrearMaquina;
var _c;
__turbopack_context__.k.register(_c, "CrearMaquina");
...
//# sourceMappingURL=_7fe3188e._.js.map