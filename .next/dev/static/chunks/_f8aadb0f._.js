...
"[project]/app/admin/clientes/crear/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CrearClientePage() {
    ...
    async function handleSubmit(e) {
        ...
        setLoading(true);
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("clientes").insert([
                formData
            ]);
...
_s(CrearClientePage, "Ze/O6Jz6Ayopn89Hy6nMFE5QksM=", false, function() {
    return [
...
_c = CrearClientePage;
var _c;
__turbopack_context__.k.register(_c, "CrearClientePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_f8aadb0f._.js.map