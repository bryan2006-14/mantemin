...
function LoginPage() {
    ...
    async function handleLogin(e) {
        ...
        const { data, error: queryError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("usuarios").select("*").eq("email", email).eq("password", password).single();
        if (queryError || !data) {
...
//# sourceMappingURL=_0784924d._.js.map