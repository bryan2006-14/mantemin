...
"[project]/app/admin/ordenes/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OrdenesPage() {
    ...
    async function cargarOrdenes() {
        try {
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("ordenes").select("*");
            if (filtro !== "todas") {
            ...
            const ordenesConDatos = await Promise.all((data || []).map(async (orden)=>{
                // Cargar máquina
                const { data: maquina } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("maquinas").select("codigo, marca, modelo, cliente_id").eq("id", orden.maquina_id).maybeSingle();
                // Cargar cliente
                let cliente = null;
                ...
                // Cargar técnico
                const { data: tecnico } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("usuarios").select("nombre, email").eq("id", orden.tecnico_id).maybeSingle();
                return {
                    ...orden,
                    maquinas: maquina ? {
                        ...maquina,
    ...
    async function eliminarOrden(id) {
        ...
        setEliminandoId(id);
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("ordenes").delete().eq("id", id);
            if (error) {
                throw error;
            }
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                            children: ordenes.map((orden)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
...
_s(OrdenesPage, "Xa6oEBGC69TkiMxAH1yUE5RBajg=", false, function() {
    return [
...
_c = OrdenesPage;
var _c;
__turbopack_context__.k.register(_c, "OrdenesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_ddcdc74c._.js.map