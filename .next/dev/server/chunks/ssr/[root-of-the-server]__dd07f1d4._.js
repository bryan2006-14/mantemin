...
"[project]/app/admin/tecnicos/[id]/delete/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EliminarTecnicoPage() {
    const [tecnico, setTecnico] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadTecnico() {
            try {
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("usuarios").select("id, nombre, email").eq("id", params.id).eq("rol", "tecnico").single();
    ...
    async function handleDelete() {
        ...
        setDeleting(true);
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("usuarios").delete().eq("id", params.id);
            if (error) throw error;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dd07f1d4._.js.map