...
"[project]/app/tecnico/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
// Simulación de Supabase (reemplaza con tu import real)
const supabase = {
    auth: {
        getSession: async ()=>({
                data: {
...
function DashboardTecnico() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (user) {
            const channel = supabase.channel('ordenes-tecnico').on('postgres_changes', {
                event: 'INSERT',
                schema: 'public',
                table: 'ordenes',
    ...
    async function cargarOrdenesDelTecnico(usuario) {
        try {
            ...
            // Primero intentar con el ID del usuario auth
            let tecnicoId = usuario.id;
            // Buscar el técnico en la tabla usuarios
            const { data: tecnicoBD, error: errorTecnico } = await supabase.from("usuarios").select("*").eq("email", usuario.email).eq("rol", "tecnico").single();
            if (tecnicoBD) {
                tecnicoId = tecnicoBD.id;
        ...
        `).eq("tecnico_id", tecnicoId).order("created_at", {
                ascending: false
            }).limit(50); // Limitar a las últimas 50 órdenes
            if (ordenesError) {
                throw ordenesError;
            }
    ...
    async function iniciarTrabajo() {
        ...
        try {
            ...
            const { error: updateError } = await supabase.from("ordenes").update({
                estado: "en_progreso",
                fecha_inicio: ahora
        ...
        // Opcional: Redirigir a página de trabajo
            ...
            children: [
                ...
                ordenes.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        ordenesCompletadas.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                    className: "text-xl font-bold mb-3 flex items-center gap-2",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4",
                                    children: ordenesCompletadas.slice(0, 5).map((orden)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(OrdenCard, {
                                            orden: orden,
                                            onVerDetalles: verDetallesOrden,
                                            seleccionada: ordenSeleccionada?.id === orden.id
                                        }, orden.id, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d2a913a3._.js.map