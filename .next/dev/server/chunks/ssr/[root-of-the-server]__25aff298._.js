...
function CrearTecnico() {
    ...
    async function registrarTecnico(e) {
        ...
        const { data: existente } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("usuarios").select("*").eq("email", email).maybeSingle();
        if (existente) {
            setError("El correo ya está registrado por otro usuario");
            return;
        }
        // 2) Insertar nuevo técnico
        const { error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("usuarios").insert([
            {
                nombre,
                email,
                password,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__25aff298._.js.map