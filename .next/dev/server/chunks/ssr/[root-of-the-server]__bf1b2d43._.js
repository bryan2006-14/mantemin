...
function LoginPage() {
    ...
    async function handleLogin(e) {
        ...
        const { data, error: queryError } = await supabase.from("usuarios").select("*").eq("email", email).eq("password", password).single();
        if (queryError || !data) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bf1b2d43._.js.map