...
function LoginPage() {
    ...
    async function login(e) {
        e.preventDefault();
        setErrorMsg("");
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
            email: email,
            password: pass
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b7947cbd._.js.map