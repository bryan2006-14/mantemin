...
function AdminDashboard() {
    ...
    async function cargar() {
        const [{ count: m }, { count: t }, { count: o }, { count: ta }] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("maquinas").select("*", {
                count: "exact"
            }).then((r)=>r.count),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("usuarios").select("*", {
                count: "exact"
            }).eq("rol", "tecnico").then((r)=>r.count),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("ordenes").select("*", {
                count: "exact"
            }).then((r)=>r.count),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("tareas").select("*", {
                count: "exact"
            }).then((r)=>r.count)
        ]);
        setCounts({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aa6702f2._.js.map