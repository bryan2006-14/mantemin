...
function CrearOT() {
    ...
    async function cargarClientes() {
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("clientes").select("*");
        setClientes(data);
    }
    async function cargarMaquinas() {
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("maquinas").select("*");
        setMaquinas(data);
    }
    async function crearOT(e) {
        e.preventDefault();
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("ordenes").insert({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6199e7e2._.js.map